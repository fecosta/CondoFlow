...
export default async function PortariaEncomendasPage({
  ...
  function buildHref(overrides: Record<string, string | undefined>) {
    ...
    return `/portaria/encomendas${params.toString() ? `?${params}` : ""}`;
  }

  return (
    <div className="space-y-4">
      <div className="flex items-center justify-between">
        <h1 className="text-2xl font-bold">Portaria — Encomendas</h1>
      ...
      <div className="flex items-center gap-2">
        ...
        <form method="GET" action="/portaria/encomendas" className="flex items-center gap-2">
